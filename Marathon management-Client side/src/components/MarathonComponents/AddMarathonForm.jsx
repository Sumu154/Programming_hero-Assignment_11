...
const AddMarathonForm = () => {
  ...
  const handleAddMarathon = async (e) => {
    ...
    const marathon = { title, marathonStart, regStart, regEnd, location, distance, image, description, createdAt, regCount };
    ...
    <div className='max-w-[600px] mx-auto bg-white mt-14   dark:bg-cardbackground'>
      ...
      <form onSubmit={handleAddMarathon} className="card-body">
        ...
        <div className="form-control">
          ...
          <textarea name="description" id="" cols="30" rows="3" className=' rounded-lg px-4 py-2'></textarea>
        </div>
